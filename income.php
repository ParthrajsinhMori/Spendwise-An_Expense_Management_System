    ...
    $.ajax({
        ...
        success:function(response){
            ...
            for(i=0;i<response.length;i++){
                ...
                output+="<tr style='background-color: white; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); transition: transform 0.2s ease;'>"+"<td style='padding: 15px;'>"+response[i].date+"</td>"+"<td style='padding: 15px;'>"+response[i].category+"</td>"+"<td style='padding: 15px;'>"+response[i].amount+"</td>"+"<td style='padding: 15px;'>"+response[i].additional_info+"</td>"+"<td><a href='update_income.php?no="+response[i].srno+"' style='color:green;'>Edit</a>"+ " " +"<a href='delete_income.php?no="+response[i].srno+"' style='color:red;'>Delete</a></td>"+"</tr>";
            }
            $('#output').html(output);
        }
    });
