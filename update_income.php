...
<?php
    ...
    $sql="SELECT * FROM user_income WHERE email='$email' AND srno=$srno";
    ...
    if(mysqli_num_rows($result)>0){
        ...
        echo "<script type='text/javascript'>alert('Income does not exists')</script>";
...
<?php
    // echo $category;
    $arr=["Salary","Freelancing","Part time","Stock Market","Others"];
    for($i=0;$i<5;$i++){
        if($arr[$i]==$category){
            $category=$i+1;
            break;
...
<div class="form-container">
        <h2 class="text-center mb-4">Update Income Form</h2>
        <form action="" id="uploadForm">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="category" name="category">
                    ...
                    <option value="1" <?php if($category==1) echo "selected";?>>Salary</option>
                    <option value="2" <?php if($category==2) echo "selected";?>>Freelancing</option>
                    <option value="3" <?php if($category==3) echo "selected";?>>Part time</option>
                    <option value="4" <?php if($category==4) echo "selected";?>>Stock Market</option>
                    <option value="5" <?php if($category==5) echo "selected";?>>Others</option>
                </select>
                <p id="categoryErr"></p>
            </div>
            <div class="form-group">
